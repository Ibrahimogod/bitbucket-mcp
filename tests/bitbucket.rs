...
async fn test_get_repository_success() {
    ...
    let _m = server.mock("GET", "/2.0/repositories/ws/repo")
        .with_status(200)
...
async fn test_get_workspace_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/workspaces/ws")
        .with_status(200)
        .with_body(r#"{"slug": "ws"}"#)
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_list_pullrequests_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests")
        .with_status(200)
...
async fn test_list_issues_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/issues")
        .with_status(200)
...
async fn test_get_user_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/user")
        .with_status(200)
...
async fn test_list_workspaces_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/workspaces")
        .with_status(200)
...
async fn test_list_repositories_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws")
        .with_status(200)
...
async fn test_list_pullrequest_tasks_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/1/tasks")
        .with_status(200)
        .with_body(r#"{"values": []}"#)
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_add_pullrequest_task_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("POST", "/2.0/repositories/ws/repo/pullrequests/1/tasks")
        .with_status(201)
...
async fn test_get_pullrequest_diffstat_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/1/diffstat")
        .with_status(200)
        .with_body(r#"{"values": []}"#)
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_merge_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("POST", "/2.0/repositories/ws/repo/pullrequests/1/merge")
        .with_status(200)
...
async fn test_list_pullrequest_comments_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/1/comments")
        .with_status(200)
        .with_body(r#"{"values": []}"#)
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_list_pullrequest_activity_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/1/activity")
        .with_status(200)
        .with_body(r#"{"values": []}"#)
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_get_pullrequest_diff_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/1/diff")
        .with_status(200)
...
async fn test_approve_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("POST", "/2.0/repositories/ws/repo/pullrequests/1/approve")
        .with_status(200)
...
async fn test_unapprove_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/repositories/ws/repo/pullrequests/1/approve")
        .with_status(200)
...
async fn test_decline_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("POST", "/2.0/repositories/ws/repo/pullrequests/1/decline")
        .with_status(200)
...
async fn test_delete_repository_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/repositories/ws/repo")
        .with_status(204)
        .with_body("")
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_delete_branch_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/repositories/ws/repo/refs/branches/feature-1")
        .with_status(204)
        .with_body("")
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_delete_issue_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/repositories/ws/repo/issues/123")
        .with_status(204)
        .with_body("")
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_delete_project_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/workspaces/ws/projects/PROJ")
        .with_status(204)
        .with_body("")
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_delete_snippet_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("DELETE", "/2.0/snippets/ws/abc123")
        .with_status(204)
        .with_body("")
        .create_async().await;
    let client = make_client(&server.url());
...
async fn test_create_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("POST", "/2.0/repositories/ws/repo/pullrequests")
        .with_status(201)
...
async fn test_get_pullrequest_not_found() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("GET", "/2.0/repositories/ws/repo/pullrequests/42")
        .with_status(404)
...
async fn test_update_pullrequest_success() {
    let mut server = mockito::Server::new_async().await;
    let _m = server.mock("PUT", "/2.0/repositories/ws/repo/pullrequests/1")
        .with_status(200)
